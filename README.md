...
開発コスト（時間・AI API・インフラ）を無駄にする最大の原因は、すでに機能している部分への過剰投資。KPI スコアが良好な軸は、改善提案が来ても「現状維持」と即答できる。

### KPI 状態 × 投資判断

| KPI 状態 | 投資判断 | 理由 |
|----------|---------|------|
| 🔴 | **集中投資** — 他を止めてでも直す | 放置コストが最大 |
| 🟡 | **計画投資** — 次サイクルに予算確保 | 悪化する前に手を打つ |
| 🟢 | **投資凍結** — リファクタ・改善提案を却下 | 壊す方が高くつく |
